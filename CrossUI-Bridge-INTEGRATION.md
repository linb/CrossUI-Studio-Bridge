...
export default function Demo() {
  ...
  <!-- Optional: ref attribution (see Section 5) -->
...
> [!TIP]
> **Partner Attribution (Earn Commission)**: If you are a CrossUI partner (see https://studio.crossui.com/partners), attach your partner `ref` ID. Studio uses a last-click, 60-day cookie. When the visitor creates an account, attribution locks to that account permanently. Later upgrades from any device are credited to you. Settled commissions arrive as itemized monthly transfers in your own Stripe dashboard.

> [!NOTE]
> No partner ID? The button works exactly the same — attribution is completely optional and adds zero friction for your readers.
